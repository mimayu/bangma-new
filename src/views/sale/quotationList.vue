<template>
  <div id="quoteList" class="quoteList_container">
    <ul class="quote_tabs">
...
import { getQuoteChange, getAddQuote, postSubmit, getSubmitInfo } from '@/server';
      ...
      getQuoteChange(params).then(
        res => {
          if(res.success == 1) {
            ...
            this.details = Object.values(res.templeResult);
            this.iCustomerId = id;
