<template>
    <div class="supplement_container">
        <Row class="header">
...
<script>
    ...
    import { getSupplement } from '@/server';
        ...
        methods: {
            ...
            */
            handleClick(type, id) {
                switch(type) {
                    case 1:
                        window.location.href= "http://www.51bangma.com/zhucai/leibie/?iCustomerId="+id+"&backurl=http://m.51bangma.com/supplement";
                        break;
                    default:
                        break;
                }
